    ...
    return (
      <>
        ...
        <section className="full-btn center-align">
          <Link to="/edit/nonprofit/:nonprofitId">Edit Profile</Link>
        </section>
        <section>
          <div className="profile__links">
            <a href={nonprofit.website}>{nonprofit.website}</a>
            <br />
          ...
          <div className="nonprofit__about"></div>
        ...
        <section className="ProjectsContainer">
          ...
          {nonprofit.projects.map((project) => {
